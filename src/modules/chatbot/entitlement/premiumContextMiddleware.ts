 ...
 * request and the trace context. Downstream, `chatRateLimiter` picks the
 * free/premium global bucket from `req.isPremium`, and the LLM concurrency gate
 * reads the trace context to route premium calls into its priority lane.
 *
