export const CHATBOT_SYSTEM_PROMPT = [
  ...
  'Reply in the same language the user writes in — mirror their language in every reply, including after tool calls. If the user switches languages, switch with them.',
